...
\title{Rigid Body Dynamics of Multiple Bodies}
...
\section*{Preface}
This is literally my lecture notes plus the slides for Grade 11 Physics, Grade
12 Physics and AP Physics 1.

%The material in this booklet are usually presented over two $2\frac12$-hour
%classes for both my Grade 11 and AP Physics 1 classes, and one $2\frac12$-hour
%to my Grade 12 classes as a review.
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[vectors] (8.5,.5)--(9.3,.5) node[right]{$\vec F$};
  \end{tikzpicture}
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[scale=4/3]
    ...
    \draw[vectors] (-1,.5)--(0,.5) node[pos=0,left]{$\vec F$};
  \end{tikzpicture}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{.4\textwidth}
    \centering
    \begin{tikzpicture}[scale=4/3,orange,vectors]
      \fill circle (.07);
  ...
  \begin{subfigure}{.4\textwidth}
    \centering
    \begin{tikzpicture}[scale=4/3,vectors,violet]
      \fill circle (.07);
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[vectors] (3,.5)--(4.5,.5) node[right]{$\vec F$};
  \end{tikzpicture}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{.4\textwidth}
    \centering
    \begin{tikzpicture}[vectors,violet]
      \fill (1.5,.5) circle (.1);
...
%    \column{.25\textwidth}
%    \centering
%    \begin{tikzpicture}[scale=.95,vectors,orange]
%      \fill circle (.08);
