\section{Rigid Body Dynamics of Multiple Connected Bodies}
\label{sec:multibody}
...
\subsection{Motion Along Level Surfaces}

\subsubsection{Objects Connected by Massless Cables}
...
inaccurate}, and pulled to the right by an external force $\bm F$ across a
level floor, as shown in Figure~\ref{fig:tension}. The coefficient of kinetic
friction between the masses and the floor is $\mu$.
\begin{figure}[ht]
  \centering
  \begin{tikzpicture}
    \draw[thick] (0,0)--(10,0);
...
\begin{enumerate}
\item What is the acceleration ($\bm a$) of the system, assuming that the
  cables do not break?
\item What are the magnitudes of the tension forces ($F_{T_1}$ and $F_{T_2}$) in
  the two cables?
\end{enumerate}
In order to answer these questions, we must find the forces acting on each of
the masses.
  ...
  \begin{tikzpicture}[lightgray]
    ...
    \begin{scope}[vector]
      \begin{scope}[orange]
        ...
        \draw (1.75,.5)--(1.75,-1) node[below]{$m_3\bm g$};
          \draw (1.75,.5)--(1.75,2) node[above]{$\bm N_3$};
          \draw (1.75,.5)--(3,.5) node[above]{$\bm T_2$};
          \draw (1.75,.5)--(1,.5) node[below]{$\bm f_3$};
      \end{scope}
      \begin{scope}[violet]
        \fill (4.75,.5) circle (.1);
        \draw (4.75,.5)--(4.75,-1) node[below]{$m_2\bm g$};
        \draw (4.75,.5)--(4.75,2) node[above]{$\bm N_2$};
        \draw (4.75,.5)--(6,.5) node[above]{$\bm T_1$};
        \draw (4.75,.54)--(3.5,.54) node[above]{$\bm T_2$};
        \draw (4.75,.46)--(4,.46) node[below]{$\bm f_2$};
      \end{scope}
      \begin{scope}[blue]
        \fill (7.75,.5) circle (.1);
        \draw (7.75,.5)--(7.75,-1) node[below]{$m_1\bm g$};
        \draw (7.75,.5)--(7.75,2) node[above]{$\bm N_1$};
        \draw (7.75,.5)--(9.75,.5) node[right]{$\bm F$};
        \draw (7.75,.54)--(6.5,.54) node[above]{$\bm T_1$};
        \draw (7.75,.46)--(7,.46) node[below]{$\bm f_1$};
      \end{scope}
    \end{scope}
  \end{tikzpicture}
...
\item External force $\bm F$ is only applied to $m_1$, therefore it
...
\subsubsection{Another Connected Bodies Example}
Two masses ($m_1$ and $m_2$) are being pushed along a level surface by an
external applied force $\bm F$, as shown in Figure~\ref{fig:pushed}. The
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[scale=4/3]
    ...
    \draw[vector] (-1,.5)--(0,.5) node[pos=0,left]{$\bm F$};
  \end{tikzpicture}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{.4\textwidth}
    ...
    \begin{tikzpicture}[scale=4/3,orange,vector]
      \fill circle (.07);
      \draw (0,0)--+(1.4,0) node[right]{$\bm F$};
      \draw (0,0)--+(0,-1) node[right]{$m_1\bm g$};
      \draw (0,0)--+(0,1) node[left]{$\bm N_1$};
      \draw (0,.05)--+(-.8,0) node[above]{$\bm N_{12}$};
      \draw (0,0)--+(-.5,0) node[below]{$\bm f_1$};
    \end{tikzpicture}
    \subcaption{Mass $m_1$}
  \end{subfigure}
  \begin{subfigure}{.4\textwidth}
    ...
    \begin{tikzpicture}[scale=4/3,vector,violet]
      \fill circle (.07);
      \draw (0,0)--+(0,1) node[right]{$\bm N_2$};
      \draw (0,0)--+(-.45,0) node[below]{$\bm f_2$};
      \draw (0,0)--+(0,-1) node[right]{$m_2\bm g$};
      \draw (0,0)--+(.8,0) node[right]{$\bm N_{12}$};
    \end{tikzpicture}
    \subcaption{Mass $m_2$}
  \end{subfigure}
...
\item The normal force $\bm N_{12}$ is at the contact between the two masses.
...
$\bm F$ is applied to $m_2$, causing both blocks to accelerate to the right
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \draw[vector] (3,.5)--(4.5,.5) node[right]{$\bm F$};
  \end{tikzpicture}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{.4\textwidth}
    ...
    \begin{tikzpicture}[orange,vector]
      ...
      \draw (1.5,1.375)--+(1.5,0) node[right,fill=yellow!30]{$\bm f$};
      \draw (1.5,1.375)--+(0,-1.2) node[right]{$m_1\bm g$};
      \draw (1.5,1.375)--+(0,1.2)  node[left=3,fill=pink!20]{$\bm N_{12}$};
    \end{tikzpicture}
  \end{subfigure}
  \begin{subfigure}{.4\textwidth}
    \centering
    \begin{tikzpicture}[vector,violet]
      \fill (1.5,.5) circle (.1);
      \draw (1.5,.5)--+(2,0) node[right]{$\bm F$};
      \draw (1.5,.5)--+(-1.5,0) node[left,fill=yellow!30]{$\bm f$};
      \draw (1.55,.5)--+(0,-1.2) node[right]{$m_2\bm g$};
      \draw (1.45,.5)--+(0,-1.2) node[left=3,fill=pink!20]{$\bm N_{12}$};
      \draw (1.5,.5)--+(0,1.2) node[left]{$\bm N_2$};
    \end{tikzpicture}
  \end{subfigure}
\end{figure}
...
%      \fill circle (.08);
%      \draw (0,0)--(1.5,0) node[right]{$\bm f_s$};
%      \draw (0,0)--(0,-1.2) node[right]{$m_1\bm g$};
%      \draw (0,0)--(0,1.2) node[left]{$\bm N_{12}$};
%    \end{tikzpicture}
%
...
\subsection{Atwood Machine--Pulley Problems}
