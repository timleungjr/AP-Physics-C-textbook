...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[scale=.4]
    ...
    \draw[vector,blue] (-8,0)--+(0,3) node[above]{$\mathbf v_1$};
    \draw[vector,red] (4,0)--+(0,-6) node[below]{$\mathbf v_2$};
    \draw[vector,blue] (-8,0)--+(1.5,0) node[above]{$\mathbf F_g$};
    \draw[vector,red] (4,0)--+(-3,0) node[above]{$\mathbf F_g$};
