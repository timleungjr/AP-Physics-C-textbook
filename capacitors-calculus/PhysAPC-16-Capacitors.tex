...
configuration shown in Fig.~\ref{fig:spherical-capacitor}, the inner sphere
carries a charge of +Q, while the outer spherical shell carries a charge of
$-Q$. The electric field between the sphere is
\begin{equation*}
  E=\frac1{4\pi\epsilon_0}\frac Q{r^2}
\end{equation*}
as we have already determined. Therefore the electric potential difference
between the inner sphere ($r=a$) and the outer spherical shell $r=b$) is given
by:
\begin{equation*}
...
is discussed in depth in Chapter~\ref{chapter:circuits}.
