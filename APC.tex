...
\newcommand{\iii}{\hat{\bm i}}
\newcommand{\jjj}{\hat{\bm j}}
...
\hypersetup{
	pdftitle={AP Physics C Made Slightly Easier}, % Title field
...
\titlepage % Output the title page
	...
	{ % Title(s) and author(s)
		...
		{\Huge\bfseries AP Physics C Made Easy\par} % Book title
		\vspace{16pt} % Vertical whitespace
		{\LARGE With Some Calulus\par} % Subtitle
...
\noindent \textit{First Draft, December 2025} % Printing/edition date
...
\chapterimage{momentum-calculus/PoolBallsRack}
\input{momentum-calculus/momentum-impulse-collisions}
...
\chapterimage{universalGravitation/54371346378-f762763e96-o}
\input{universalGravitation/univGravity}

%TEMP\part{Electricity and Magnetism}
%TEMP
%TEMP\input{electrostatics/PhysAPC-14-Electrostatics}
%TEMP\input{electrostatics2/PhysAPC-15-gaussLaw}
%TEMP\input{capacitors-calculus/PhysAPC-16-Capacitors}
%TEMP\input{magnetism/PhysAPC-17-magnetism1}
%TEMP\input{magnetism2/PhysAPC-18-faradaysLaw}
%TEMP%\input{../magnetism3/PhysAPC-19-faradaysLawAsymmetry}
%TEMP\input{circuits1-calculus/PhysAPC-20-Circuits}
%TEMP\input{circuits2-calculus/PhysAPC-21-circuitAnalysis2}
...
\begin{appendices}
  ...
  \input{harmonicMotion/harmonicMotion-appendix}
